...
#include "../BeobachterWuerfel_Client/CCornerBalance.h"
...
static const char qt_meta_stringdata_CCornerBalance[] = {
    "CCornerBalance\0\0runCornerBalanceSIG()\0"
    "stopCornerBalanceSIG()\0reloadConfigSIG()\0"
    "time,data\0CompLQR3DPhiReceivedSLOT(double,QVector<double>)\0"
    "CompLQR3DUKReceivedSLOT(double,QVector<double>)\0"
    "CompLQR3DURRecievedSLOT(double,QVector<double>)\0"
    "CompLQR3DTMReceivedSLOT(double,QVector<double>)\0"
...
const QMetaObjectExtraData CCornerBalance::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CCornerBalance::staticMetaObject = {
    { &CExperimentWidget::staticMetaObject, qt_meta_stringdata_CCornerBalance,
      qt_meta_data_CCornerBalance, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CCornerBalance::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CCornerBalance))
